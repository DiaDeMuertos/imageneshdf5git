...
if __name__ == '__main__':
    ...
    if "1" == op.strip():
        print "Opcion 1 DEFAULT inica en 2 segudos"
        print "\n"
        time.sleep(2)       
